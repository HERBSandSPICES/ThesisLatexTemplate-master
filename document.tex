...
\newcommand{\documentAdviser}{Jay Robert B. del Rosario}
...
\newcommand{\examinerC}{Cesar A. Llorente}

\newcommand{\examinerDTitle}{Engr.} 
\newcommand{\examinerD}{Mark Lorenze D. Torregoza}

\newcommand{\deanTitle}{Engr.} 
\newcommand{\deanName}{Rionel B. Caldo}
...
\newcommand{\keywords}{microcontroller, watering system, automated, gardening}
\newcommand{\approvalDate}{May~30,~\the\year} % put here the date when all examiners and/or their approved representative have given their approval; do not remove the tildes in order to not break the date; the submission deadline can also be placed as the date
